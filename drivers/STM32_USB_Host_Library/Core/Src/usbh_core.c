    ...
    else
    {
      ...
      if(phost->pActiveClass != NULL)
      {
        ...
        else
        {
          ...
          USBH_UsrLog ("\r\nDevice not supporting %s class.", phost->pActiveClass->Name);
        }
      }
      else
      {
...
static USBH_StatusTypeDef USBH_HandleEnum (USBH_HandleTypeDef *phost)
{
  ...
  case ENUM_GET_FULL_DEV_DESC:
    ...
    {
      USBH_UsrLog("\r\nPID: %04xh", phost->device.DevDesc.idProduct );
      USBH_UsrLog("\r\nVID: %04xh", phost->device.DevDesc.idVendor );
  ...
  case ENUM_GET_MFC_STRING_DESC:
    ...
    { /* Check that Manufacturer String is available */
                               ...
                               0xFFU) == USBH_OK)
      {
        ...
        USBH_UsrLog("\r\nManufacturer : %s",  (char *)(void*)phost->device.Data);
  ...
  case ENUM_GET_PRODUCT_STRING_DESC:
    ...
    { /* Check that Product string is available */
                               ...
                               0xFFU) == USBH_OK)
      {
        ...
        USBH_UsrLog("\r\nProduct : %s",  (char *)(void *)phost->device.Data);
    ...
    { /* Check that Serial number string is available */
                               ...
                               0xFFU) == USBH_OK)
      {
        /* User callback for Serial number string */
         USBH_UsrLog("\r\nSerial Number : %s",  (char *)(void*)phost->device.Data);
        Status = USBH_OK;
      }
    }
    else
